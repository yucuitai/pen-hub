...
/** 启动文章生成任务 POST /article/start/${param0} */
export async function startArticle(taskId: string, options?: { [key: string]: any }) {
  return request<API.BaseResponseBoolean>(`/article/start/${taskId}`, {
    method: 'POST',
    ...(options || {}),
  })
}
